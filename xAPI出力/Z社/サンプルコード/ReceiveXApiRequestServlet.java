...
/**
 * xAPIステートメントリクエストを受信して返答するサーブレット
 * 
 */
@WebServlet(name = "ReceiveXApiRequestServlet", urlPatterns = "/receive_xapi_request")
public class ReceiveXApiRequestServlet extends XApiServletBase {

	/** ログ出力用 */
	private static Logger logger = Logger.getLogger(ReceiveXApiRequestServlet.class);
