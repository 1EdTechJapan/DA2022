package com.CompanyName.lti.lib;

import com.CompanyName.lti.lib.oauth2.OAuthAuthenticationFailureHandler;
import com.CompanyName.lti.lib.oauth2.client.lti.authentication.OidcLaunchFlowAuthenticationProvider;
import com.CompanyName.lti.lib.oauth2.client.lti.authentication.TargetLinkUriAuthenticationSuccessHandler;
import com.CompanyName.lti.lib.oauth2.client.lti.web.*;
...
public class Lti13Configurer extends AbstractHttpConfigurer<Lti13Configurer, HttpSecurity> {
    ...
    private final OidcLaunchFlowAuthenticationProvider oidcLaunchFlowAuthenticationProvider;
