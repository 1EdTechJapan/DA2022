...
import jp.co.example.programming.openapi.controller.oneRoster.EnrollmentsManagementApi;
import jp.co.example.programming.openapi.controller.oneRoster.UsersManagementApi;
import jp.co.example.programming.openapi.data.oneRoster.EnrollmentDType;
import jp.co.example.programming.openapi.data.oneRoster.EnrollmentSetDType;
import jp.co.example.programming.openapi.data.oneRoster.UserDType;
import jp.co.example.programming.openapi.data.oneRoster.UserSetDType;
